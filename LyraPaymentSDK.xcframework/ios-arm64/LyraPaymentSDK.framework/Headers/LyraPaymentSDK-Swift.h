...
enum LyraPaymentMethods : NSInteger;
SWIFT_CLASS("_TtC14LyraPaymentSDK14ProcessOptions")
@interface ProcessOptions : NSObject
/// The expected value for this key in the options dictionary is a String thats represents the text for display  in PAY button.
@property (nonatomic, readonly, copy) NSString * _Nonnull customPayButtonLabel;
/// The expected value for this key in the options dictionary is a String thats represents the text for display  in the header of Payment Form .
@property (nonatomic, readonly, copy) NSString * _Nonnull customHeaderLabel;
/// The expected value for this key in the options dictionary is a String thats represents the text for display in loading popup  while payment is in process .
@property (nonatomic, readonly, copy) NSString * _Nonnull customPopupLabel;
/// The expected value for this key in the options dictionary is
@property (nonatomic, readonly) enum LyraPaymentMethods paymentMethodType;
- (nonnull instancetype)initWithCustomPayButtonLabel:(NSString * _Nonnull)customPayButtonLabel customHeaderLabel:(NSString * _Nonnull)customHeaderLabel customPopupLabel:(NSString * _Nonnull)customPopupLabel paymentMethodType:(enum LyraPaymentMethods)paymentMethodType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC14LyraPaymentSDK22ExtendedProcessOptions")
@interface ExtendedProcessOptions : ProcessOptions
/// Represents if the card scan functionality is enabled or not.
@property (nonatomic, readonly) BOOL cardScanningEnabled;
/// Represents the apple merchant identifier. Necessary for support Apple Pay functionality
@property (nonatomic, readonly, copy) NSString * _Nonnull applePayMerchantId;
/// Represents  the person or company receiving payment.
@property (nonatomic, readonly, copy) NSString * _Nonnull applePayMerchantName;
- (nonnull instancetype)initWithCustomPayButtonLabel:(NSString * _Nonnull)customPayButtonLabel customHeaderLabel:(NSString * _Nonnull)customHeaderLabel customPopupLabel:(NSString * _Nonnull)customPopupLabel paymentMethodType:(enum LyraPaymentMethods)paymentMethodType cardScanningEnabled:(BOOL)cardScanningEnabled applePayMerchantId:(NSString * _Nonnull)applePayMerchantId applePayMerchantName:(NSString * _Nonnull)applePayMerchantName OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCustomPayButtonLabel:(NSString * _Nonnull)customPayButtonLabel customHeaderLabel:(NSString * _Nonnull)customHeaderLabel customPopupLabel:(NSString * _Nonnull)customPopupLabel paymentMethodType:(enum LyraPaymentMethods)paymentMethodType SWIFT_UNAVAILABLE;
@end

SWIFT_CLASS("_TtC14LyraPaymentSDK11InitOptions")
@interface InitOptions : NSObject
/// Represents the name of the theme file to be used for the customization of the SDK views. If not set, the default name PaymentSdkTheme is used to find the theme file.
...
/// Represents  the person or company receiving payment.
@property (nonatomic, readonly, copy) NSString * _Nonnull applePayMerchantName;
- (nonnull instancetype)initWithTheme:(NSString * _Nonnull)theme cardScanningEnabled:(BOOL)cardScanningEnabled applePayMerchantId:(NSString * _Nonnull)applePayMerchantId applePayMerchantName:(NSString * _Nonnull)applePayMerchantName OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
/// \param apiServerName String Represents the REST API Server Name (available in merchant BO: Settings->Shop->REST API Keys)
///
...
+ (BOOL)initialize:(NSString * _Nonnull)publicKey :(NSString * _Nonnull)apiServerName :(InitOptions * _Nonnull)options error:(NSError * _Nullable * _Nullable)error;
...
///
/// \param options Optional dictionary allowing to customize the payment
///
///
/// throws:
/// Throws an NSError using the LyraSdkError class if the SDK was not previously initialized.
+ (BOOL)process:(UIViewController * _Nonnull)contextViewController :(NSString * _Nonnull)formToken onSuccess:(void (^ _Nonnull)(LyraResponse * _Nonnull))onSuccess onError:(void (^ _Nonnull)(LyraError * _Nonnull, LyraResponse * _Nullable))onError :(ProcessOptions * _Nonnull)options error:(NSError * _Nullable * _Nullable)error SWIFT_DEPRECATED_MSG("process method with callbacks is deprecated. Use process async method instead");
...
@property (nonatomic, strong) LyraResponse * _Nullable lyraResponse;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, LyraPaymentMethods, open) {
  LyraPaymentMethodsAll = 0,
  LyraPaymentMethodsCard = 1,
  LyraPaymentMethodsApplePay = 2,
};
